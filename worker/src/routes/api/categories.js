...
import { categories, categoryStats, transactions, createDatabase } from '@finance-manager/db';
...
const budgetPeriods = ['monthly', 'quarterly', 'yearly'];
...
categoriesRouter.put('/:id', async (c) => {
    try {
        ...
        if (body.subtype !== undefined)
            updateData.subtype = body.subtype?.trim() || null;
        ...
        if (body.defaultBudgetAmount !== undefined)
            updateData.defaultBudgetAmount = body.defaultBudgetAmount || null;
        if (body.budgetPeriod !== undefined)
            updateData.budgetPeriod = body.budgetPeriod;
        if (body.isActive !== undefined)
            updateData.isActive = body.isActive;
        if (body.allowSubcategories !== undefined)
            updateData.allowSubcategories = body.allowSubcategories;
        if (body.tags !== undefined)
            updateData.tags = body.tags ? JSON.stringify(body.tags) : null;
        if (body.rules !== undefined)
            updateData.rules = body.rules ? JSON.stringify(body.rules) : null;
