...
describe('Uploads API', () => {
    ...
    describe('POST /api/uploads', () => {
        ...
        it('should generate embeddings and store in Vectorize', async () => {
            ...
            expect(mockEnv.AI.run).toHaveBeenCalledWith('@cf/baai/bge-base-en-v1.5', expect.objectContaining({
                text: expect.any(String)
            }));
            // Verify Vectorize insert was called
            expect(mockEnv.VECTORIZE_INDEX.insert).toHaveBeenCalledWith(expect.arrayContaining([
    ...
    describe('POST /api/uploads/search', () => {
        ...
        it('should handle search with filters', async () => {
            ...
            expect(mockEnv.VECTORIZE_INDEX.query).toHaveBeenCalledWith(expect.any(Array), // embedding vector
            expect.objectContaining({
                topK: 10,
