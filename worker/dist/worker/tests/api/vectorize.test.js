...
describe('Vectorize Integration', () => {
    ...
    describe('Embedding Generation', () => {
        it('should generate embeddings using Cloudflare AI', async () => {
            ...
            expect(mockEnv.AI.run).toHaveBeenCalledWith('@cf/baai/bge-base-en-v1.5', { text: text });
        ...
        it('should handle special characters and formatting', async () => {
            ...
            expect(mockEnv.AI.run).toHaveBeenCalledWith('@cf/baai/bge-base-en-v1.5', { text: textWithSpecialChars });
            expect(result.data).toBeDefined();
        });
    });
    ...
    describe('Semantic Search', () => {
        ...
        it('should apply metadata filters correctly', async () => {
            ...
            expect(mockEnv.VECTORIZE_INDEX.query).toHaveBeenCalledWith(queryVector, expect.objectContaining({
                filter: filters
            }));
        });
