...
import {
  ...
  validateAccountName,
  validateAccountType,
} from "../../src/web/pages/api/accounts";
...
describe("Account API Validation", () => {
  describe("validateAccountCode", () => {
    ...
    it("should return error for empty or null codes", () => {
      ...
      expect(validateAccountCode(undefined as any)).toBe(
        "Account code is required"
      );
    });

    it("should return error for codes that are too short", () => {
      expect(validateAccountCode("1")).toBe(
        "Account code must be at least 3 characters"
      );
      expect(validateAccountCode("12")).toBe(
        "Account code must be at least 3 characters"
      );
    });
    ...
    it("should return error for codes that are too long", () => {
      ...
      expect(validateAccountCode(longCode)).toBe(
        "Account code must be at most 20 characters"
      );
    });
  ...
  describe("validateAccountName", () => {
    ...
    it("should return error for empty or null names", () => {
      ...
      expect(validateAccountName(undefined as any)).toBe(
        "Account name is required"
      );
    });

    it("should return error for names that are too short", () => {
      expect(validateAccountName("A")).toBe(
    ...
    it("should return error for names that are too long", () => {
      ...
      expect(validateAccountName(longName)).toBe(
        "Account name must be at most 100 characters"
      );
    });
  ...
  describe("validateAccountType", () => {
    ...
    it("should return error for invalid account types", () => {
      expect(validateAccountType("INVALID")).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
      );
      expect(validateAccountType("asset")).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
      );
      expect(validateAccountType("Asset")).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
    ...
    it("should return error for empty or null types", () => {
      expect(validateAccountType("")).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
      );
      expect(validateAccountType(null as any)).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
      );
      expect(validateAccountType(undefined as any)).toBe(
        "Account type must be one of: ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE"
      );
    });
