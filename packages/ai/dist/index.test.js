...
describe('AI Service Tests', () => {
    ...
    describe('Cloudflare Provider', () => {
        ...
        it('should format messages correctly', async () => {
            ...
            const formattedPrompt = provider.formatMessages(messages);
    ...
    describe('Financial AI Service', () => {
        ...
        it('should analyze transactions', async () => {
            ...
            const result = await financialAI.analyzeTransaction(transaction);
        ...
        it('should categorize expenses', async () => {
            ...
            const result = await financialAI.categorizeExpense('Pens and paper from Staples', 25.99, 'Staples');
        ...
        it('should generate transaction entries', async () => {
            ...
            const result = await financialAI.generateTransactionEntries('Purchased office supplies with cash', 100, accounts);
