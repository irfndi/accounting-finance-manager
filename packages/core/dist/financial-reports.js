...
export async function generateIncomeStatementPDF(incomeStatement, options) {
    try {
        const doc = new jsPDF();
        // Header
        doc.setFontSize(20);
...
export async function generateIncomeStatementExcel(incomeStatement, options) {
    try {
...
export async function generateTrialBalancePDF(trialBalance, options) {
    try {
        const doc = new jsPDF();
        // Header
        doc.setFontSize(20);
...
export async function generateTrialBalanceExcel(trialBalance, options) {
    try {
        const workbook = new ExcelJS.Workbook();
