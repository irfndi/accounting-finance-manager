...
const POST = async ({ request }) => {
    try {
        const { period, metrics, includeForecasting, includeRiskAnalysis } = await request.json();
        // Generate comprehensive financial insights
        const insights = await generateFinancialInsights({ period, metrics, includeForecasting, includeRiskAnalysis });
        return new Response(JSON.stringify({ success: true, result: { insights } }), {
            status: 200,
            headers: {
