...
export default function FinancialStatements() {
    ...
    const renderFinancialDataRows = (items, level = 0) => {
        return items.map((item) => (<React.Fragment key={item.id}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <Select value={selectedYear} onValueChange={setSelectedYear}>
                ...
                <SelectContent>
                  {yearOptions.map(year => (<SelectItem key={year.value} value={year.value}>
                      {year.label}
                    </SelectItem>))}
                </SelectContent>
              </Select>
        ...
        <CardContent>
          ...
          <Tabs defaultValue="balance-sheet" className="w-full">
            ...
            <TabsContent value="balance-sheet" className="space-y-6">
              {balanceSheet ? (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Assets */}
                  <Card>
                    <CardHeader>
            ...
            <TabsContent value="income-statement" className="space-y-6">
              {incomeStatement ? (<Card>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow className="border-t-2 border-gray-300 font-bold">
                          ...
                          <TableCell className={`text-right font-mono ${incomeStatement.netIncome >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                ...
                </Card>) : (<div className="text-center text-gray-500 py-8">
                    ...
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow className="border-t-2 border-gray-300 font-bold">
                          ...
                          <TableCell className={`text-right font-mono ${cashFlow.netCashFlow >= 0 ? 'text-green-600' : 'text-red-600'}`}>
