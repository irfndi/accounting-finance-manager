...
export default function FinancialStatements() {
  ...
  const fetchBalanceSheet = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/reports/balance-sheet?year=${selectedYear}&period=${selectedPeriod}`
      );
      if (!response.ok) {
        throw new Error(
  ...
  const fetchIncomeStatement = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/reports/income-statement?year=${selectedYear}&period=${selectedPeriod}`
      );
      if (!response.ok) {
        throw new Error(
  ...
  const fetchCashFlow = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/reports/cash-flow?year=${selectedYear}&period=${selectedPeriod}`
      );
      if (!response.ok) {
