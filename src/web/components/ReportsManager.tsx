  ...
  const checkDataAvailability = async () => {
    try {
      ...
      if (accountsResponse.ok && statsResponse.ok) {
        ...
        const hasAccounts = accountsResult.accounts && accountsResult.accounts.length > 0;
        const hasTransactions = statsResult.success && statsResult.stats.transactions.monthlyCount > 0;
      ...
      <Card className="p-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-6">
            You need to set up your chart of accounts and add transactions before generating financial reports.
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="text-sm text-gray-600">Account listing report</span>
            </Button>
            ...
            >
              ...
              <span className="text-sm text-gray-600">Account balances summary</span>
            </Button>
            ...
            >
              ...
              <span className="text-sm text-gray-600">Monthly transaction report</span>
            </Button>
          </div>
        </CardContent>
      </Card>
