...
function generateTransactionAlertEmail(data) {
...
function generateAccountActivityEmail(data) {
...
${activities.map((activity) => `- ${activity.date}: ${activity.description} - $${activity.amount}`).join('\n')}
...
function getBudgetAlertTemplate() {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
function getMonthlyReportTemplate() {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
