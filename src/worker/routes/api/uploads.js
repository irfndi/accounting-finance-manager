...
import { createDatabase, createRawDoc, updateRawDocOCR, getRawDocByFileId, generateSearchableText, parseTags, getUploadStats } from '../../../db/index.js';
                        ...
                        try {
                            ...
                            if (documentClassification && documentClassification.confidence > 0.6) {
                                ...
                                try {
                                    ...
                                    const __embeddingResult = await vectorizeService.embedDocument(fileId, textForEmbedding, embeddingMetadata);
