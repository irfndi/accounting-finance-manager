/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93f931593990ada1f2df229d8dbcaa1f)
// Runtime types generated with workerd@1.20250617.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		AUTH_SESSION_DURATION: "7d" | "1h";
		AWS_REGION: "us-east-1";
		SES_FROM_EMAIL: "noreply@finance-manager.com" | "test@finance-manager.com";
		SES_FROM_NAME: "Finance Manager" | "Finance Manager Test";
		JWT_SECRET: "dev-jwt-secret-please-change-in-production-use-strong-random-key" | "test-jwt-secret-key-for-testing-only";
